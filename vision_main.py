...
def args_parser():
    ...
    # Model Arguments
    parser.add_argument("--layer", type=str, default="Attention", choices=["Attention", "ConvNNAttention", "FastConvNNAttention", "FlashConvNNAttention", "KvtAttention", "LocalAttention", "NeighborhoodAttention", "SparseAttention"], help="Layer to use for training and evaluation")
