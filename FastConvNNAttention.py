...
"""FastMultiHeadConvNNAttention Module that utilizes the fused Triton kernels for efficient attention computation."""
...
if __name__ == "__main__":
    ...
    if device.type != "cuda":
        ...
        model = FastMultiHeadConvNNAttention(
            ...
            convolution_type="depthwise" # Change to "standard" to test the standard convolution version
        ).to(device)
