...
def args_parser():
    ...
    # Model Arguments
    parser.add_argument("--layer", type=str, default="Attention", choices=["Attention", "ConvNNAttention", "KvtAttention", "LocalAttention", "NeighborhoodAttention", "BranchConv", "BranchAttention", "ConvNNAttention_Modified"], help="Layer to use for training and evaluation")
