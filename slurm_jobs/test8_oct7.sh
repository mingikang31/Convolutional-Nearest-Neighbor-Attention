...
python main.py --layer ConvNNAttention --K 4 --sampling_type all --dataset cifar10 --output_dir ./Output/Oct6-VIT-Tiny-Sanity/CIFAR10/ConvNNAttention_All_K4_s42_NH1_topksoftmax --num_epochs 50 --seed 42 --lr 1e-5 --lr_step 2 --lr_gamma 0.95 --num_heads 1
...
python main.py --layer BranchAttention --K 9 --sampling_type all --dataset cifar10 --output_dir ./Output/Oct6-VIT-Tiny-Sanity/CIFAR10/BranchAttention_ConvNNAttention_All_K9_br0500_s42_NH1_topksoftmax --num_epochs 50 --seed 42 --lr 1e-5 --lr_step 2 --lr_gamma 0.95 --branch_ratio 0.5 --num_heads 1
