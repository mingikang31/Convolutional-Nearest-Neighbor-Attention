...
python main.py --layer ConvNNAttention_Same_KVT --K 9 --sampling_type all --dataset cifar10 --output_dir ./Output/Sanity_Oct16/ConvNNKvt_K9_s42_cosine_softmax --num_epochs 50 --seed 42 --lr 1e-5 --lr_step 2 --lr_gamma 0.95 --num_heads 1
...
python main.py --layer ConvNNAttention_Same_KVT --K 25 --sampling_type all --dataset cifar10 --output_dir ./Output/Sanity_Oct16/ConvNNKvt_K25_s42_cosine_softmax --num_epochs 50 --seed 42 --lr 1e-5 --lr_step 2 --lr_gamma 0.95 --num_heads 1
